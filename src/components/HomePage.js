...
const HomePage = () => {
    ...
    useEffect(() => {
        $(videoRef.current).on('timeupdate', function() {
        ...
        <>
            <div className="container-fluid">
                ...
                <div className="container-fluid custom_container1">
                    <div className="container py-5">
                        <div className="">
                            <h1 className='text-white display-5 text-center pt-5 text-nowrap'>
                                <span><i className=''>Learn/Discover What/How<span className='text-warning'>(specific big  <br />
                                    results)</span>
            ...
            <div className="container-lg register-banner">
                <div className="register-content">
                    ...
                    <p>Actual Price <strike>₹599/-</strike></p>
                </div>
            </div>
